...
public class cMap3 extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener,LocationListener {

    private GoogleMap mMap;
    private ChildEventListener mChildEventListener;
    public DatabaseReference mSites;

    private static final String TAG = "cMap3";
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder = new Geocoder(cMap3.this);
    ...
    private void getDeviceLocation(){
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(cMap3.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(cMap3.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(cMap3.this);
    }
